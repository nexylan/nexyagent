...
#if re.match('http(s)?(\:\/\/)[a-zA-Z0-9_\-]+\.(nexylan.net)', agentConfig['sdUrl']) == None:
#	print 'Your sd_url is incorrect. It needs to be in the form http://example.nexylan.net (or using https)'
#	print 'Agent will now quit'
#	sys.exit(1)
